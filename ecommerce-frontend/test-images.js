...
const screenshotDir = 'c:\temp\screenshots';
...
(async () => {
  ...
  try {
    ...
    await page.goto('http://127.0.0.1:5173/products/1', { waitUntil: 'networkidle' });
    await page.waitForTimeout(2000);
    ...
    const addBtn = await page.locator('button:has-text("Add to Cart")').first();
